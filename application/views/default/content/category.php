 <?php   
        $w= $katproduk_id;
 $query = $this->db->query("SELECT * FROM katproduk WHERE katproduk_id='$w'");
foreach ($query->result() as $row2){ }
?>
<ul class="breadcrumbs">
	<li><a href="<?php echo base_url();?>home">Home</a></li>
	<li><a href="<?php echo base_url();?>product">Barang</a></li>
	<li><?php echo $row2->katproduk_nama; ?></li>
</ul>
<div class="row">
	<!-- - - - - - - - - - - - - - Box - - - - - - - - - - - - - - - - -->
	...
	<main class="col-md-9 col-sm-8">
			<h1>Barang <?php echo $row2->katproduk_nama; ?></h1>
		...
		<?php 
            $i  = $page+1;
            $where_katproduk['k.katproduk_id'] = $katproduk_id;
            $where                      = (empty($katproduk_id))?'': $where_katproduk;
            if ($jml_data > 0){
             foreach ($this->ADM->grid_all_produk('*', 'produk_post', 'DESC', $batas, $page, $where, '') as $row){
        ?>  
			<li>
				<article class="entry">
