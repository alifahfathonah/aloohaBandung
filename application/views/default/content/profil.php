	...
	<section class="section_offset transparent" data-animation="fadeInDown">
			...
			<div class="tabs type_2 products">
				<ul class="tabs_nav clearfix">
					...
					<li class="active"><a href="<?php echo site_url();?>account/profil/edit/<?php echo $account->account_id; ?>">Profil</a></li>
				</ul>
				...
				<!-- ========== Flashdata ========== -->
                    ...
                    <?php } ?><br>
                    <!-- ========== End Flashdata ========== -->
							<form class="type_2" action="<?php echo site_url();?>account/profil/edit" method="post" enctype="multipart/form-data">
							<input type="hidden" name="account_id" value="<?php echo $account_id; ?>">
								<ul>
									...
									<li class="row center">
										...
										<div class="col-xs-12">
											<label for="account_foto" class="required">EDIT FOTO PROFIL </label>
											<input type="file" name="account_foto"  id="account_foto">
										</div><!--/ [col] -->
                             		   <?php } else {?>
										<div class="col-xs-12">
									...
									<li class="row">
										<div class="col-sm-6">
											...
											<input type="email" name="account_email" value="<?php echo $account_email;?>" readonly="readyonly" id="account_email">
										</div><!--/ [col] -->
										<div class="col-sm-6">
											<label for="account_password1">PASSWORD</label>
											<input type="password" name="account_password1" value=""  id="account_password1"> * Kosongkan bila tidak diubah
										</div><!--/ [col] -->
									</li><!--/ .row -->
									<li class="row">
										<div class="col-xs-12">
									...
									<li class="row">
										...
										<div class="col-sm-6">
											...
											<input type="radio"   <?php echo $yes = ($account_jk=='L')?'checked':'';?>  name="account_jk" id="L" value="L"> 
											<label for="L">Laki-laki</label>
											  <input type="radio" <?php echo $no = ($account_jk=='P')?'checked':'';?>  name="account_jk" id="P" value="P">
